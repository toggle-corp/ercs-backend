...
import fitz
from apps.reports.prompts import get_doc_summary_prompt
import base64
import json
import typing

from .models import DocumentExtraction, DocumentExtractionStatus, Report
from apps.reports.llms import OllamaHandler
...
class PdfExtraction:
    ...
    def pdf_to_images(self, zoom: float=2.0):
        ...
        print(f"doc prompt: {doc_summary_prompt}")
        doc_summary = self.llm_chat_model.invoke(doc_summary_prompt)
        print(f"Document level summary: {doc_summary}")
